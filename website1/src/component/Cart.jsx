...
function Card() {
    return (
        <motion.div className="service_container">
            ...
            <motion.div variants={container} className="service_card" 
            initial="hidden" whileInView="show" viewport={{once:false}}>

                <motion.div className="card" variants={item}>
                    <span className="service_icon" style={{ backgroundColor: "#ddfbf9" }} variants={hoverEffect} whileHover="whileHover" whileTap='whileTap'>
                ...
                <motion.div variants={item} className="card" >
                    <span className="service_icon" style={{ backgroundColor: "#e7daf8" }} variants={hoverEffect} whileHover="whileHover" whileTap='whileTap'>
                ...
                <motion.div variants={item} className="card" >
                    <span className="service_icon" style={{ backgroundColor: "#ffede6" }} variants={hoverEffect} whileHover="whileHover" whileTap='whileTap'>
                ...
                <motion.div variants={item} className="card" >
                    <span className="service_icon" style={{ backgroundColor: "#ffe1e9" }} variants={hoverEffect} whileHover="whileHover" whileTap='whileTap'>
                ...
                <motion.div variants={item} className="card" >
                    <span className="service_icon" style={{ backgroundColor: "#dcedff" }} variants={hoverEffect} whileHover="whileHover" whileTap='whileTap'>
                ...
                <div className="card" >
                    <span className="service_icon" style={{ backgroundColor: "#dbf9ed" }} variants={hoverEffect} whileHover="whileHover" whileTap='whileTap'>
                ...
                <div className="card" >
                    <span className="service_icon" style={{ backgroundColor: "#fffada" }} variants={hoverEffect} whileHover="whileHover" whileTap='whileTap'>
                ...
                <div className="card dark" >
                    ...
                    <a href="#">
                        <span>View more...</span>
                        <span className="service_icon" style={{ backgroundColor: "#14da8f" }} variants={hoverEffect} whileHover="whileHover" whileTap='whileTap'>
